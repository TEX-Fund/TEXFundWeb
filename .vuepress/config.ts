...
export default defineHopeConfig({
  ...
  lang: 'en-US',
  // title: 'TEX Fund',
  description: 'TEX.Fund : Token exchange aggregation platform', 
  head: [ 
    ['link', { rel: 'manifest', href: '/manifest.webmanifest' }],
    ['link', { rel: 'apple-touch-icon', sizes: '180x180', href: '/images/icons/apple-touch-icon.png' }],
    ['link', { rel: 'mask-icon', color: '#a02c2c', href: '/images/icons/safari-pinned-tab.svg' }],
